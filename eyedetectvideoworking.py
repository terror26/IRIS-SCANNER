...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.line(frame,(int(x+w/4.2),int(y+h/3)),(int(x+w/2.5),int(y+h/2.2)),(0,255,0),1)
        # ---------- vertical left line ----------#
        ...
        contours, hierarchy = cv2.findContours(erosion,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE) #-image, removed 
